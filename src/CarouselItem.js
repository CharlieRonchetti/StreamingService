...
const CarouselItem = ({ title, description, img, id, handleAnimeClick }) => {
  ...
  return (
    <div className='align-top inline-flex items-center lg:py-6 text-slate-50' style={{ width: "100%" }}>
        <div className="flex flex-col-reverse gap-4 lg:flex-row items-center">
            <div className="flex-col basis-5/6 max-w-9/10 ml-[5%] lg:ml-0 text-center lg:text-left">
                ...
                ></p>
                <button className="hidden ml-0.5 mt-5 bg-violet-600 py-3 px-4 mb-4 rounded-md text-4xl lg:block xl:mt-10 cursor-pointer" onClick={() => handleAnimeClick(id)}>Play Now!</button>
            </div>
            <div className="">
